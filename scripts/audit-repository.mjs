...
const report={status:failures.length?'failed':'passed',sourceMode,files:unique.length,publicAssets,relativeImportsChecked:imports,symlinks:0,largest,failures,limitations:'High-confidence credential patterns and path/import checks; not a guarantee against every possible secret. Optional archival source packages are not build dependencies.'};
