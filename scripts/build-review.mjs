...
const env={...process.env,NODE_ENV:'production',NODE_OPTIONS:'--max-old-space-size=768',IADDS_MEDIA_MODE:reviewMediaMode(),IADDS_REVIEW_BUILD:'true',SITE_URL:'http://127.0.0.1:3100',NEXT_TELEMETRY_DISABLED:'1'};
